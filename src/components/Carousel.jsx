...
const Carousel_ = () => {
    return (
        <section className='relative  h-screen flex justify-center items-center '>
            <img className='absolute h-full w-full object-cover' src="https://miegacoan.com/images/HEADER/HEADER.jpg" alt="poster mie gacoan " />
            ...
            <Carousel className='w-[20rem] md:w-[27rem] mx-auto' showArrows={false} autoPlay={true} infiniteLoop={true} showThumbs={false} showStatus={false} showIndicators={false} >
                {carousel.map((lineText, index) => (
                    <div key={index}>
                        <img src='https://miegacoan.com/images/logo-full.png' className="scale-[.6]" alt='logo mie gacoan ' />
                        <img src={lineText.src} alt={lineText.alt} className='-mt-5 lg:-mt-10' />
