  ...
  return (
    <footer className=' w-full py-10 opacity-85'>
      <div className='max-w-[60rem] mx-auto px-[1rem] lg:px-0'>
        <div className='sm:flex items-center justify-between border-b-2 border-white/50 capitalize'>
          Hubungi kami untuk informasi lebih lanjut!
          <div className='flex items-center gap-3 sosmed'>
            <div className="card">
              <Link to={"/"} aria-disabled={true} className="socialContainer containerOne" href="#">
              ...
              <Link to={"/"} className="socialContainer containerFour group/icon" href="#" aria-disabled={true}>
        ...
        <div className='flex flex-col sm:grid grid-cols-3 mt-5 gap-10'>
          <div className='flex flex-col gap-3'>
            <img width={60} height={60} src='https://miegacoan.com/images/logo-full.png' alt='logo mie gacoan' />
          ...
          <div className='flex flex-col gap-3'>
            ...
            <div className='flex items-center gap-3'>
              <img width={35} height={35} src='https://miegacoan.vercel.app/static/media/ramenColor.38bc9dbf9ad9fd47976b.png' alt='mie' />
              <p className='capitalize font-semibold'>mie</p>
            </div>
            <div className='flex items-center gap-3'>
              <img width={35} height={35} src='https://miegacoan.vercel.app/static/media/dimsumColor.a5f735c7d492c808eece.png' alt='dimsum' />
              <p className='capitalize font-semibold'>dimsum</p>
            </div>
            <div className='flex items-center gap-3'>
              <img width={35} height={35} src='https://miegacoan.vercel.app/static/media/poinsettiaColor.cfe7ac06a5db5c9f68f8.png' alt='minuman' />
        ...
        <p className='border-t-2 text-center mt-7 py-2'>&copy; 2022 <Link to={"https://portofolio-ersaridhofangestus-projects.vercel.app"} className='font-semibold hover:text-blue-999 transition-all duration-500 ease-in-out' >Ersa Ridho Fangestu</Link>. All Rights Reserved.</p>
      </div>
    </footer >
  )
}
